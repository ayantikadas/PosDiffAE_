...
#                     raise NotImplementedError()
            ...
            if "vb" in terms:
                ...
                terms["loss"] = terms["mse"] + (0.001)*terms['regres_loss'] 
        else:
...
#                 print("gt_keep_mask")
#                 print("time",t)
#                 plt.imshow(gt_keep_mask[0,0,:,:].detach().cpu())
#                 plt.axis('off')
#                 plt.show()
                
#                 print("(1 - gt_keep_mask)")
#                 plt.imshow((1 - gt_keep_mask)[0,0,:,:].detach().cpu())
#                 plt.axis('off')
#                 plt.show()
                

#                 print("((1 - gt_keep_mask) * (weighed_gt))")
#                 plt.imshow(((1 - gt_keep_mask) * (weighed_gt))[0,:,:,:].detach().cpu().permute(1,2,0))
#                 plt.axis('off')
#                 plt.show()
#                 print("((gt_keep_mask) * (x))")
#                 plt.imshow(((gt_keep_mask) * (x))[0,:,:,:].detach().cpu().permute(1,2,0))
#                 plt.axis('off')
#                 plt.show()
#                 print("weighed_gt")
#                 plt.imshow((weighed_gt)[0,:,:,:].detach().cpu().permute(1,2,0))
#                 plt.axis('off')
#                 plt.show()
...
#         plt.imshow(out["pred_xstart"][0,:,:,:].detach().cpu().permute(1,2,0))
#         plt.axis('off')
#         plt.show()
#         print("Mean pred")
