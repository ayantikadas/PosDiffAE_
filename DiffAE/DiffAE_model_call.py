...
#         os.path.abspath('././DiffAE_model_call.py').split('DiffAE_model_call')[0]+'DiffAE/'
        data_config_path = os.path.abspath('././DiffAE_model_call.py').split('DiffAE_model_call')[0]+'DiffAE/'+'/config_file_.yaml'
